...
class Ui_MainWindow(object):
    ...
    def loadPreset(self):
        ...
        self.runsSpinBox.valueFromText(f.readline().replace('\n', ''))
        ...
        self.aOffsetSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.bOffsetSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.cOffsetSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.dOffsetSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.modeComboBox.setCurrentText(f.readline().replace('\n', ''))
        self.timebaseSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.segmentsSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.capturesSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.totalRuntimeSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.timeUnitsComboBox.setCurrentText(f.readline().replace('\n', ''))
        self.preTriggerSamplesSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.postTriggerSamplesSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.samplesPerBufferSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.triggerTypeComboBox.setCurrentText(f.readline().replace('\n', ''))
        self.aAutotriggerSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.aDelaySpinBox.valueFromText(f.readline().replace('\n', ''))
        ...
        self.aUpperThresholdSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.bUpperThresholdSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.cUpperThresholdSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.dUpperThresholdSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.extUpperThresholdSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.aUpperHysteresisSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.bUpperHysteresisSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.cUpperHysteresisSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.dUpperHysteresisSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.extUpperHysteresisSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.aLowerThresholdSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.bLowerThresholdSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.cLowerThresholdSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.dLowerThresholdSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.extLowerThresholdSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.aLowerHysteresisSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.bLowerHysteresisSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.cLowerHysteresisSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.dLowerHysteresisSpinBox.valueFromText(f.readline().replace('\n', ''))
        self.extLowerHysteresisSpinBox.valueFromText(f.readline().replace('\n', ''))
